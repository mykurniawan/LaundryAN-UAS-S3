...
$queryOutlet = mysqli_query($conn, "SELECT * FROM toutlet WHERE idOutlet = '" . $_GET['idOutlet'] . "'");
...
if (isset($_POST['submit'])) {
    ...
    $alamat = $_POST['alamat'];
    $telepon = $_POST['teleponOutlet'];

    $sql = "UPDATE toutlet SET namaOutlet='" . $namaOutlet . "',alamat='" . $alamat . "', teleponOutlet ='" . $telepon . "' WHERE idOutlet= '" . $idOutlet . "'";
    $update = mysqli_query($conn, $sql);
    if ($update) {
        echo "<script>alert('Sukses edit'); location.href='dataOutlet.php'</script>";
    } else {
        echo "<script>alert('Gagal edit'); location.href='editOutlet.php'</script>";
    }
}
?>
<!DOCTYPE html>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            <a href="dataOutlet.php" class="btn btn-primary">Data Outlet</a>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Edit Outlet</h3>
                            <p class="text-subtitle text-muted">Edit outlet</p>
                        </div>
                        ...
                        <div class="">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Masukkan data outlet</h4>
                                </div>
