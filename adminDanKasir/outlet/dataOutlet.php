                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="buatOutlet.php">Buat Outlet</a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Outlet</h3>
                            <p class="text-subtitle text-muted">Tabel Daftar Outlet LaundryAN</p>
                        </div>
                            ...
                            <table class="table" id="table1">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= $no ?></td>
                                            <td><?= $dataOutlet['idOutlet'] ?></td>
                                            <td><?= $dataOutlet['namaOutlet'] ?></td>
                                            <td><?= $dataOutlet['alamat'] ?></td>
                                            <td><?= $dataOutlet['teleponOutlet'] ?></td>
                                            <td>
                                                <!-- <a href="dataOutlet.php?idOutlet = <?= $dataOutlet['idOutlet'] ?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><img src="../../assets/icons/edit.png" alt=""></a> -->
                                                <a href="editOutlet.php?idOutlet= <?= $dataOutlet['idOutlet'] ?>"><img src="../../assets/icons/edit.png" alt=""></a>

                                                <a href="hapusO.php?idOutlet= <?= $dataOutlet['idOutlet'] ?>"><img src="../../assets/icons/trash.png" alt=""></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
