                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            ...
                            <button type="submit" class="btn btn-primary me-1 mb-1">
                                <a style="color: white; text-decoration: none;" href="cetakO.php" target="_BLANK">Cetak</a>
                            </button>
                        </li>
                    </ul>
                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="editStatus.php?idOrder= <?= $dataOrder['idOrder'] ?>"><img src="../../assets/icons/edit.png" alt=""></a>
