                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Edit Order</h3>
                            <p class="text-subtitle text-muted">Tabel Daftar Order</p>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="eo.php?idOrder= <?= $dataOrder['idOrder'] ?>"><img src="../../assets/icons/edit.png" alt=""></a>
                                                <!-- <a href="hapusM.php?idMember= <?= $dataMember['idMember'] ?>"><img src="../assets/icons/trash.png" alt=""></a> -->
                                                <!-- <a href="../transaksi/transaksi.php?idOrder= <?= $dataOrder['idOrder'] ?>"><img src="../../assets/icons/cash.png" alt=""></a> -->
                                            </td>
                                        </tr>
                                    <?php
                                    }
