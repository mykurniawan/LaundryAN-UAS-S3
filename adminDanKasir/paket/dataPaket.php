                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Paket</h3>
                            <p class="text-subtitle text-muted">Tabel Daftar Paket</p>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="hapusP.php?idJC= <?= $dataPaket['idJC'] ?>"><img src="../../assets/icons/trash.png" alt=""></a>
                                                <a href="editP.php?idJC= <?= $dataPaket['idJC'] ?>"><img src="../../assets/icons/edit.png" alt=""></a>
