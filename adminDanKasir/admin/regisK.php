                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <button type="submit" class="btn btn-primary me-1 mb-1">
                                <a style="color: white; text-decoration: none;" href="cetakdataM.php" target="_BLANK">Cetak</a>
                            </button>
                        </li>
                    </ul>
                </div>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Create Kasir</h3>
                            <p class="text-subtitle text-muted">Tambahkan Kasir Baru</p>
                        </div>
                        ...
                        <div class="">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Masukkan data kasir</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="prosesRegisKasir.php" method="POST" class="form form-horizontal">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group has-icon-left">
                                                            <div class="position-relative">
                                                                <input type="text" name="nama" class="form-control" placeholder="Nama" id="first-name-icon">
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="form-group has-icon-left">
                                                            <div class="position-relative">
                                                                <input type="text" name="username" class="form-control" placeholder="Username" id="first-name-icon">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-person"></i>
                                                                </div>
                                                            </div>
