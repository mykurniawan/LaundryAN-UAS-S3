                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item">
                            <button type="submit" class="btn btn-primary me-1 mb-1">
                                <a style="color: white; text-decoration: none;" href="../adminDanKasir/order/cetakO.php" target="_BLANK">Cetak</a>
                            </button>
                        </li>
                    </ul>
                </div>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Data Orderan</h3>
                            <p class="text-subtitle text-muted">Tabel Daftar Orderan LaundryAN</p>
                        </div>
                                ...
                                <ol class="breadcrumb">
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-end">
                                            <button type="submit" class="btn btn-primary me-1 mb-1">
                                                <a style="color: white; text-decoration: none;" href="../dOwner.php">Kembali</a>
                                            </button>
                                        </div>
                                    </div>
                                </ol>
